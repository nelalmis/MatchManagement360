...
//               </Text>
//             </View>
//             {/* Kayıt uygunluğu badge'i */}
//             {canRegisterToMatch(stats.nextMatch, user?.id, null) ? (
//               <View style={[styles.matchStatusBadge, { backgroundColor: '#DCFCE7' }]}> 
//                 <Text style={[styles.matchStatusText, { color: '#16a34a' }]}>Kayıt Olunabilir</Text>
//               </View>
//             ) : (
//               <View style={[styles.matchStatusBadge, { backgroundColor: '#FEE2E2' }]}> 
//                 <Text style={[styles.matchStatusText, { color: '#DC2626' }]}>Kayıt Kapalı</Text>
//               </View>
//             )}
